...
- **Entitlements File**: `Config/AIAssistantApp.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/AIAssistantApp.entitlements`:
